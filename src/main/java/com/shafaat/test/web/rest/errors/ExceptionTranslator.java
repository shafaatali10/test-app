package com.shafaat.test.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.shafaat.test.service.EmailAlreadyUsedException ||
            ex instanceof com.shafaat.test.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.shafaat.test.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.shafaat.test");
    }
}
