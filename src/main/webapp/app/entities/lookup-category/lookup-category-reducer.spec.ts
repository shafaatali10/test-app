...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOOKUPCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOOKUPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOOKUPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOOKUPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOOKUPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOOKUPCATEGORY actions', async () => {
      const expectedActions = [
        {
