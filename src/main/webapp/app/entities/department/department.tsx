          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('deptCode')}>
                  <Translate contentKey="testAppApp.department.deptCode">Dept Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('deptCode')} />
                </th>
                <th className="hand" onClick={sort('deptName')}>
                  <Translate contentKey="testAppApp.department.deptName">Dept Name</Translate>{' '}
