        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Dept Code" id="department-deptCode" name="deptCode" data-cy="deptCode" type="text" />
              <ValidatedField label="Dept Name" id="department-deptName" name="deptName" data-cy="deptName" type="text" />
