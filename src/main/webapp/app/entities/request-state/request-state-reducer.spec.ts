...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTSTATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTSTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTSTATE actions', async () => {
      const expectedActions = [
        {
