...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERALDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERALDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERALDATA actions', async () => {
      const expectedActions = [
        {
