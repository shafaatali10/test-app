...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OTHERDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_OTHERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OTHERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OTHERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OTHERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OTHERDETAILS actions', async () => {
      const expectedActions = [
        {
