...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hddl-file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HDDLFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_HDDLFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HDDLFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HDDLFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HDDLFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HDDLFILE actions', async () => {
      const expectedActions = [
        {
