...
import com.shafaat.test.domain.Employee;
import com.shafaat.test.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).salary(UPDATED_SALARY).deptId(UPDATED_DEPT_ID);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.salary(UPDATED_SALARY).deptId(UPDATED_DEPT_ID);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).salary(UPDATED_SALARY).deptId(UPDATED_DEPT_ID);
